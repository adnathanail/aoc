...
def get_sensors_and_beacons(inp: str) -> tuple[list[tuple[int, int]], list[tuple[int, int]]]:
    sensors = []
    beacons = []
...
def get_grid(sensors: list[tuple[int, int]], beacons: list[tuple[int, int]], min_x: int, max_x: int, min_y: int,
             max_y: int) -> list[list[str]]:
