...
seeds_split, seed_soil_split, soil_fert_split, fert_water_split, water_light_split, light_temp_split, temp_humid_split, humid_loc_split = puzzle.examples[0].input_data.split("\n\n")
